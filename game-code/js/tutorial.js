...
tutorial.load_tutorial = function() {
  ...
  tutorial.messages = [
    ...
    ["Boxes that are too greasy, such as", "some pizza boxes, cannot be recycled.", "Send them to the landfill."],
    ...
    ["Your local rules will be different!", "It's important to follow your", "local recycling rules!"],
  ...
  tutorial.elist = [
    ...
    {trigger_time:  0, event_type: tutorial.event_types.SHOW_MESSAGE,   option_id:  10},
    {trigger_time:  0, event_type: tutorial.event_types.SHOW_HINT,      option_id: tutorial.hint_types.HIDDEN},
    {trigger_time:  1, event_type: tutorial.event_types.CONVEYOR_STATE, option_id: false},
    {trigger_time:  2, event_type: tutorial.event_types.NEXT_BUTTON,    option_id:  0},
