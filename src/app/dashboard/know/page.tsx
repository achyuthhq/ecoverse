...
import KnowAtmosContent from "@/components/know-atmos-content";
import DashboardShell from "@/components/dashboard-shell";
import { useSession } from "next-auth/react";
import ClassicLoader from "@/components/ui/classic-loader";

export default function KnowAtmosPage() {
      ...
      <div className="flex-1 space-y-4 p-4 md:p-8 pt-6 sm:pt-8 md:pt-4">
        <div className="text-center">
          <div className="flex items-center justify-center gap-2 sm:gap-3 mb-4">
            <div className="p-2 sm:p-3 bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 rounded-xl sm:rounded-2xl shadow-lg">
          ...
          <p className="text-gray-300 max-w-md mx-auto text-sm sm:text-base px-4">
            Discover recycling points, real-time weather, air quality, and environmental data in your area.
          </p>
        </div>
        ...
        <Suspense
          fallback={
            <div className="flex items-center justify-center h-[600px] glass-card rounded-xl">
              <div className="text-center">
                <ClassicLoader size="lg" />
                <h3 className="text-lg font-medium text-white mt-4">Loading Atmospheric Data</h3>
              </div>
            </div>
          }
        >
