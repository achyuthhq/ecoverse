...
export default function PixelCard({
  ...
  return (
    <div
      ref={containerRef}
      className={`relative overflow-hidden grid place-items-center border border-white/10 rounded-[25px] isolate transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none ${className}`}
      ...
      style={{
        background: 'linear-gradient(135deg, rgba(16, 16, 16, 0.9) 0%, rgba(25, 25, 25, 0.85) 50%, rgba(12, 12, 12, 0.9) 100%)',
    ...
    >
      ...
      <canvas className="w-full h-full block absolute inset-0 z-[1]" ref={canvasRef} />
      {/* Content */}
