    ...
    <div className="flex h-screen bg-white">
      <div className="flex-1 flex flex-col h-full overflow-y-auto">
        ...
        >
          ...
          {/* Add extra bottom spacing for desktop only */}
          <div className="hidden md:block" aria-hidden="true">
            <div className="h-16 md:h-24 lg:h-32 xl:h-40" />
          </div>
        </motion.div>
        ...
        <div className="fixed bottom-2 left-3 right-3 bg-white rounded-2xl shadow-lg max-w-[270px] mx-auto">
          <div className="relative">
            ...
            <div className="flex justify-between items-center py-2 px-2">
              ...
              <div className="flex gap-4 justify-end" style={{ width: "calc(50% - 32px)" }}>
              ...
              <div className="flex gap-4 justify-start" style={{ width: "calc(50% - 32px)" }}>
