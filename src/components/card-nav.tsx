...
const CardNav: React.FC<CardNavProps> = ({
  ...
  return (
    <div
      className={`card-nav-container fixed left-1/2 top-[1.2em] z-[99] w-[90%] max-w-[800px] -translate-x-1/2 md:top-[2em] ${className}`}
    >
      <nav
        ref={navRef}
      ...
      >
        <div className="card-nav-top absolute inset-x-0 top-0 z-[2] flex h-[60px] items-center justify-between p-2 pl-[1.1rem]">
          ...
          <button
            type="button"
            className="card-nav-cta-button hidden h-full items-center rounded-[calc(0.75rem-0.2rem)] px-4 font-medium transition-colors duration-300 md:inline-flex"
            style={{
